...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            if not folder_id:
                raise ValueError("folder_id is required; research is scoped to a selected folder")
            ...
            result = BoundedResearchSearchService().search(
                ...
                max_results=max(1, min(int(body.get("max_results") or 30), 40)),
            ...
            try:
                ...
                result["persistence_warning"] = f"{type(exc).__name__}: {exc}"
